...
#' @usage standardize_taxonomy(x, preferred_data_sources=11,
#' infraspecies = FALSE, fuzzy = FALSE, verbose = TRUE,
#' return = c("taxonID", "scientificNameStd", "order", "taxonRank", "warnings"))
...
#' @export
standardize_taxonomy <- function(x, preferred_data_sources=11,
                                 infraspecies = FALSE, fuzzy = FALSE,
                                 verbose = TRUE, return = c("taxonID", "scientificNameStd",
                                                            "order", "taxonRank", "warnings")) {
  ...
  temp <- get_taxonomy(x=levels(droplevels(factor(x$scientificName))),
                       ...
                       infraspecies = infraspecies, fuzzy = fuzzy,
                 verbose = verbose)

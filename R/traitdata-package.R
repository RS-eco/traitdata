...
#' @description R package to access 29 different trait datasets covering numerous taxa.
#' @details traitdata provides an easy way to access 29 publicly available trait datasets 
